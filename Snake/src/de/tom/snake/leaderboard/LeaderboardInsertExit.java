...
public class LeaderboardInsertExit {
	...
	public LeaderboardInsertExit(Main main, LeaderboardInsert leaderboardInsert) {
		this.main = main;
		this.leaderboardInsert = leaderboardInsert;
	...
	public void draw(Graphics g) {
		...
		g.setColor(Color.WHITE);
		g.drawString(LanguageString.leaderboard_insert_exit_text[Language.getLanguage(main)], main.pauseMenu.helpMenu.getXFromStringLenght(LanguageString.leaderboard_insert_exit_text[Language.getLanguage(main)], g), main.jframe.getHeight()/3);
		noButton.changeText(LanguageString.leaderboard_button_no[Language.getLanguage(main)]);
		noButton.draw(g);
		yesButton.changeText(LanguageString.leaderboard_button_yes[Language.getLanguage(main)]);
